          ...
          <div className="card-body" style={{ paddingRight: '0px', marginRight: '0px' }}>
            ...
            <div className="tab-content">
              ...
              <div className={`tab-pane ${activeTab === 'basictab3' ? 'show active' : ''}`} id="basictab3">
                <h4>¿Qué es la entrevista de despeje?</h4>
              ...
              <div className={`tab-pane ${activeTab === 'basictab4' ? 'show active' : ''}`} id="basictab4">
                <h4>Convenios y Profesionales recomendados</h4>
                <h4>Convenios</h4>
                <ul>
                  <li>
                ...
                <h4>Profesionales recomendados</h4>
                <p>
